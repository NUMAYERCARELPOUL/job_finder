...
import '../model/seeall_model.dart';
class SeeAllPageScreenView extends StatefulWidget {
  const SeeAllPageScreenView({super.key});

  @override
  State<SeeAllPageScreenView> createState() => _SeeAllPageScreenViewState();
}

class _SeeAllPageScreenViewState extends State<SeeAllPageScreenView> {
  ...
  Future<void> readJson() async {
    ...
    setState(() {
      jobList = data['jobs']
          .map((data) => SeeAllJob.fromJson(data)).toList();
    });
  }
  ...
  Widget jobComponent({required SeeAllJob job}) {
    return Container(
