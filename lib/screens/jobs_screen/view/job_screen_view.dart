...
import 'package:job_finder/screens/jobs_screen/view/seeall_screen_view.dart';
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      GestureDetector(
                        onTap: (){
                          Navigator.push(context, MaterialPageRoute(builder: (context)=>SeeAllPageScreenView()));
                        },
                        child: Text("See all",
